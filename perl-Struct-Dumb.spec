...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Struct-Dumb-0.14.tar.gz
...
%prep
%setup -q -n Struct-Dumb-0.14
cd %{_builddir}
tar xf %{_sourcedir}/libstruct-dumb-perl_0.09-1.debian.tar.xz
cd %{_builddir}/Struct-Dumb-0.14
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Struct-Dumb-0.14/deblicense/
...
cp %{_builddir}/Struct-Dumb-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Struct-Dumb/df9f2d29a10846c30925e18b0273e53356f88a79 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Struct-Dumb/df9f2d29a10846c30925e18b0273e53356f88a79
