...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Struct-Dumb-0.11.tar.gz
...
%prep
%setup -q -n Struct-Dumb-0.11
cd %{_builddir}
tar xf %{_sourcedir}/libstruct-dumb-perl_0.09-1.debian.tar.xz
cd %{_builddir}/Struct-Dumb-0.11
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Struct-Dumb-0.11/deblicense/
...
cp %{_builddir}/Struct-Dumb-0.11/LICENSE %{buildroot}/usr/share/package-licenses/perl-Struct-Dumb/7e88e362b09da4b18d7e611c14945b5734383496
if test -f Makefile.PL; then
