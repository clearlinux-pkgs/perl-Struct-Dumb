...
Version  : 0.13
Release  : 27
URL      : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Struct-Dumb-0.13.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Struct-Dumb-0.13.tar.gz
...
%prep
%setup -q -n Struct-Dumb-0.13
cd %{_builddir}
tar xf %{_sourcedir}/libstruct-dumb-perl_0.09-1.debian.tar.xz
cd %{_builddir}/Struct-Dumb-0.13
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Struct-Dumb-0.13/deblicense/
...
cp %{_builddir}/Struct-Dumb-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Struct-Dumb/1a0db8ae53618717535b6c54006100fc3e919f87 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Struct-Dumb/1a0db8ae53618717535b6c54006100fc3e919f87
